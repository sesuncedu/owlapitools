...
public class UtilTests extends AbstractSuggestorTest {
    ...
    public void testGetSubDatatypes() throws Exception {
        ...
        mngr.applyChanges(Arrays.asList(
                new AddAxiom(ont, df.getOWLFunctionalDataPropertyAxiom(p)),
        ...
        assertEquals(0, subsOfFloat.nodes().count());
        ...
        assertTrue(helper.isSubtype(
                ...
                integer));
        assertFalse(helper.isSubtype(df.getOWLDatatypeRestriction(flt,
